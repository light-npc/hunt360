...
const AboutUs = () => {
  return (
    <div className="min-h-screen flex flex-col font-sans relative overflow-x-hidden bg-gray-900 text-gray-200">
      ...
      <div className="relative z-10 flex-1 flex flex-col">
        ...
        <nav className="flex justify-between items-center px-8 py-6 border-b border-white/10 bg-slate-900/30 backdrop-blur-md">
            ...
            <div className="flex items-center">
              <Link 
                to="/" 
                className="text-sm font-semibold text-gray-300 hover:text-white transition uppercase tracking-wider"
              >
                Back to Home
              </Link>
            </div>
        ...
        <div className="flex-1 max-w-6xl mx-auto px-6 pb-16 space-y-12">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <GlassFeatureCard 
                ...
                title="Efficiency"
                desc="Automate and streamline HR workflows, saving time and reducing manual effort."
              ...
              <GlassFeatureCard 
                ...
                title="Security"
                desc="Protect sensitive HR data with enterprise-grade protocols and secure infrastructure."
                color="text-blue-400"
              ...
              <GlassFeatureCard 
                ...
                title="Insights"
                desc="Gain actionable analytics for smarter hiring and organizational decisions."
              ...
              <GlassFeatureCard 
                ...
                title="Scalability"
                desc="Designed to grow with your organization—whether you're a startup or enterprise."
          ...
          <section className="text-center py-12">
            ...
            <button className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white px-10 py-4 rounded-xl font-bold text-lg hover:shadow-lg hover:shadow-blue-500/30 transition transform hover:scale-105 border border-white/10">
              Contact Us
            </button>
          </section>
        </div>
...
// Sub-component for consistent glass styling
