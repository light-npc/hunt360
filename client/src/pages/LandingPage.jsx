        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center px-4">
            <div className="max-w-4xl flex flex-col items-center">
                ...
                <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto">
                    {/* SIGNUP BUTTON: Passes state to open Signup form directly */}
                    <Link 
                        to="/auth" 
                        state={{ view: 'signup' }}
                        className="bg-blue-600 text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-blue-500 transition transform hover:scale-105 shadow-lg shadow-blue-900/50 border border-blue-500 text-center min-w-[160px]"
                    >
                        Signup
                    </Link>
                    
                    {/* LOGIN BUTTON: Passes state to open Login form */}
                    <Link 
                        to="/auth" 
                        state={{ view: 'login' }}
                        className="backdrop-blur-sm bg-white/5 border border-white/20 text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-white/10 transition transform hover:scale-105 text-center min-w-[160px]"
                    >
                        Login
                    </Link>
                </div>
